...
Component({
  ...
  methods: {
    clickAttrValue({
      ...
      console.log('clickAttrValue', attrValueIndex, attrNameIndex);
      ...
      switch (attrValue.status) {
        case ATTR_VALUE_STATUS.UNPICKED:
          ...
          console.log('unpick it', attrValue);
    ...
    pickOnlySku(attrList) {
      const pickedAttrValues = attrList
        ...
        .filter((x) => x != null);
      console.log('pickedAttrValues', pickedAttrValues);
      ...
      console.log('pickedSku', pickedSku);
      if (pickedSku == null) {
        console.error(
